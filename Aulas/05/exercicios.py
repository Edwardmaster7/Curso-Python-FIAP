...
class Cliente:
    ...
    def buscar_produto_por_id_lista(id_busca:int):
        ...
        for i, item in enumerate[dict[str, float]](produtos_lista):
            if i == id_busca:
                return item
    ...
    '''
    def transformar_lista_para_dict(produtos_lista):
        return {i: item for i, item in enumerate[Any](produtos_lista)}
